...
# - One for the private subnet (e.g., "private-subnet", "192.168.64.0/18")
#
# Example skeletons to fill:
# Virtual Network
# resource "azurerm_virtual_network" "vnet" {
#   name                = "ENTER YOUR VNET NAME HERE"
#   address_space       = ["ENTER YOUR VNET ADDRESS SPACE HERE"]
...
#   name                 = "ENTER YOUR PUBLIC SUBNET NAME HERE"
#   resource_group_name  = azurerm_resource_group.rg.name
#   virtual_network_name = azurerm_virtual_network.vnet.name
#   address_prefixes     = ["ENTER YOUR PUBLIC SUBNET ADDRESS PREFIX HERE"]
# }

# # Private Subnet
# resource "azurerm_subnet" "private_subnet" {
#   name                 = "ENTER YOUR PRIVATE SUBNET NAME HERE"
#   resource_group_name  = azurerm_resource_group.rg.name
#   virtual_network_name = azurerm_virtual_network.vnet.name
#   address_prefixes     = ["ENTER YOUR PRIVATE SUBNET ADDRESS PREFIX HERE"]
# }
