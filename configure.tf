...
# TODO: Students write azurerm_virtual_network "vnet" and TWO azurerm_subnet resources:
# - One for the public subnet (e.g., "public-subnet", "192.168.0.0/19")
# - One for the private subnet (e.g., "private-subnet", "192.168.64.0/19")
#
